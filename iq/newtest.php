  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a href="Dashboard.php" class="nav-link">Exit</a>
        </li>
      </ul>
    ...
    <div class="quizContainer container-fluid well well-lg bg-secondary" style="height: 500px;">
        <div id="quiz1" class="text-center">
      
      <h2>IQ Quiz</h2>
            </span></h4>
    
    <div id="count"><span style="color: #FFF;" id="timer"></span>: left</div>
    </div>
      ...
      <div class="result" style="display: block;"></div>
         <button class="previButton bg-success" value="submit" id="next">Previous Question</button>
